 ...
 */
(function(){var e;e=t("q"),n.exports=function(t,n,r){var o,i,u,c,f,s,a,p,l;if(a=[],f=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)},s=function(t){return"function"==typeof t},u=e.defer(),f(t)||(t=[t]),o=t.length+1,!f(n)){if(!s(n))throw new Error("Callbacks must be an array of functions");n=[n]}for(p=0,l=n.length;l>p;p++){if(i=n[p],!s(i))throw new Error("Callback is not a function");a.push({handle:i})}return c=function(){var n,i;return n=0,(i=function(c){var f,s,p;if(e.isPending(u.promise)){if(p=a[n++],!p)return c?u.reject(c):u.resolve(),void("function"==typeof r&&r(c));try{return f=p.handle.length,c?f===o+1?p.handle.apply(void 0,[c].concat(t,[i])):i(c):o+1>f?p.handle.apply(void 0,t.concat([i])):i()}catch(l){return s=l,i(s)}}})()},c(),u.promise}}).call(this)},{q:3}],2:[function(t,n){function e(){}// shim for using process in browser
